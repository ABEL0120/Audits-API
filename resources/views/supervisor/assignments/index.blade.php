    ...
    <tbody>
        ...
        <tr class="border-t hover:bg-gray-50">
            ...
            <td class="px-4 py-2 flex gap-2">
                <a href="{{ route('supervisor.assignments.edit', $a) }}" class="text-blue-600">Editar</a>
                <form action="{{ route('supervisor.assignments.destroy', $a) }}" method="POST" onsubmit="return confirm('¿Eliminar esta asignación?')">
                    @csrf @method('DELETE')
