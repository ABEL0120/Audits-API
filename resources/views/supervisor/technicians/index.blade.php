...
<table class="w-full bg-white shadow rounded">
    ...
    <tbody>
        ...
        <tr class="border-t">
            ...
            <td class="px-4 py-2">
                <form method="POST" action="{{ route('supervisor.technicians.destroy', $technician) }}" onsubmit="return confirm('¿Eliminar técnico?');">
                    @csrf @method('DELETE')
                    <button class="text-red-600 hover:underline">Eliminar</button>
                </form>
                <a href="{{ route('supervisor.technicians.edit', $technician) }}" class="text-blue-600 hover:underline">Editar</a>
            </td>
        </tr>
        @endforeach
    </tbody>
